...
class photosLayout: UICollectionViewLayout {
    ...
    var minimumItemWidth = 100 as CGFloat
    var maximumItemWidth = UIScreen.main.bounds.width - 10 as CGFloat
    var itemHeight = (UIScreen.main.bounds.width - 10) * 2 / 3  as CGFloat
