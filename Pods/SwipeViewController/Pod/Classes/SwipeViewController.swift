...
open class SwipeViewController: UINavigationController, UIPageViewControllerDelegate, UIScrollViewDelegate, Navigation, BarButtonItem, SwipeButton, SelectionBar,UINavigationBarDelegate {
    ...
    public func navigationBar(_ navigationBar: UINavigationBar, didPop item: UINavigationItem) {
        ...
        if viewControllers.count == 1 {
            UIView.animate(withDuration: 1, animations: {
                self.navigationBar.frame = CGRect(x: 0, y: 0, width: navigationBar.frame.width , height: 64)
            })
        }
    }
