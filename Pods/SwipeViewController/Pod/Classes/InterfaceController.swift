...
struct NavigationView {
    ...
    mutating func initNavigationView() -> (UIView) {
        ...
        title.textColor = UIColor(red: 0, green: 148/255, blue: 176/255, alpha: 1)
        ...
        title.frame = CGRect(x: 0 , y: -22, width: delegate.viewWidth, height: 44)
        title.text = swipeButtonDelegate?.tit
